...
public interface TransportConfiguration<SCC extends StreamClientConfiguration, SSC extends StreamServerConfiguration> {
	...
	/**
	 * Creates a {@link com.distrimind.upnp_igd.transport.spi.StreamClient} using the given {@link ExecutorService} for async calls.
	 *
	 * @param executorService used to dispatch request/response processing.
	 * @return created {@link com.distrimind.upnp_igd.transport.spi.StreamClient}
	 */
	StreamClient<SCC> createStreamClient(final ExecutorService executorService,
										 final StreamClientConfiguration configuration);

	/**
	 * Creates a {@link com.distrimind.upnp_igd.transport.spi.StreamServer} using the given {@code listenerPort}.
	 *
	 * @param listenerPort port to listen on
	 * @return created {@link com.distrimind.upnp_igd.transport.spi.StreamServer}
	 */
